  ...
  else if (pattern_len >= criteria_sum)
  {
    ...
    for (uint i = left_criteria_pad; i <= last_idx; ++i)
    {
      ...
      if (no_blocking_dots && no_blocking_thorp_left && no_blocking_thorp_right)
      {
        ...
        u64 left_arr = NumArrangementsBitmaskSplit(left_thorp_pattern, left_dot_pattern, left_len,
        ...
        u64 right_arr = NumArrangementsBitmaskSplit(right_thorp_pattern, right_dot_pattern, right_len,
